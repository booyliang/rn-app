...
export default (variables) => {
	...
	const headerTheme = {
		...
		"NativeBase.Left": {
			...
			flex: 0,
			minWidth: styles.transformSize(190),
			alignSelf: "center",
			alignItems: "flex-start",
		},
		"NativeBase.Body": {
		...
		// paddingTop: platform === "ios" ? 15 : variables.androidToolbarPaddingTop,
		paddingTop: variables.PaddTopHeader,
		// borderBottomWidth: platform === "ios" ? 1 / PixelRatio.getPixelSizeForLayoutSize(1) : 0,
		borderBottomWidth: 1,
		borderBottomColor: variables.toolbarDefaultBorder,
		// height: platform === "ios" ?  variables.toolbarHeight : 46 + variables.androidToolbarPaddingTop,
