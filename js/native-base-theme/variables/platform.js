...
export default {
	...
	// Header
	toolbarBtnColor: platform === "ios" ? "#666" : "#666",
	...
	toolbarTextColor: platform === "ios" ? "#333" : "#333",
	toolbarDefaultBorder: platform === "ios" ? "#a7a6ab" : "#3F51B5",
	iosStatusbar: platform === "ios" ? "dark-content" : "light-content",
	androidToolbarPaddingTop: Platform.Version >= 23 ? StatusBar.currentHeight : 0,
	...
	// header paddingTop
	get PaddTopHeader() {
		if (platform === "ios" && w === 375 && h === 812) {
			return 40;
		} else if ( platform === "ios" ) {
			return 15;
		} else { 
			return this.androidToolbarPaddingTop;
		}
	},
	...
	get headerHeight() { 
		if (platform === "ios" && w === 375 && h === 812) {
			...
			return 46 + this.androidToolbarPaddingTop;
		}
	},
};
