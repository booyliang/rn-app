			...
			>
				...
				<ImageBackground source={bg2} style={{ flex: 1 }}>
					<View style={styles.slide}>
						...
						<LottiePage ref={(lot) => this.lottie2 = lot} source={require('./assets/lottie2.json')} style={styles.lottie2} />
						{/* <View style={styles.docWarp}	>
...
const styles = StyleSheet.create({
	...
	slide: {
		flex: 1,
		paddingTop: utils.isIphoneX() ? 110 : 70,
		alignItems: 'center',
	},
	image: {
		width,
	...
	font1: {
		...
		width: getFinalWidth(903),
		height: getFinalHeight(82)
	},
	font2: {
		// paddingLeft: 34,
		marginBottom: utils.isIphoneX() ? 85 : 45,
		width: getFinalWidth(900),
		height: getFinalHeight(82)
	},
	font3: {
		// paddingLeft: 34,
		marginBottom: utils.isIphoneX() ? 90 : 50,
		width: getFinalWidth(811),
		height: getFinalHeight(86)
	},
	buttonWarp: {
		position: "absolute",
