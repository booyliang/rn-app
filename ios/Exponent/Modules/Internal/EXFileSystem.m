...
RCT_EXPORT_MODULE(EXFileSystem)
- (id)init {
  if ((self = [super init])) {
  _downloadObjects = [NSMutableDictionary dictionary];
  _documentDirectory = [[self class] documentDirectoryForExperienceId:@"@yryz"];
  _cachesDirectory = [[self class] cachesDirectoryForExperienceId:@"yryz"];
