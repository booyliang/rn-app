...
public class SystemUtils {
     ...
     * @return
     */
    public static void getIMEI(final Context context, final Promise promise, final WritableMap map) {
    ...
    public static String getIp(Context mContent) {
        ...
        try {
            if (hasPermissions(mContent, Manifest.permission.ACCESS_WIFI_STATE)) {
                //获取wifi服务
...
//                wifiManager.setWifiEnabled(true);
    ...
    public static boolean hasPermissions(Context context, String... perms) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            Log.w("systemUtils", "hasPermissions: API version < M, returning true by default");
            return true;
        }
